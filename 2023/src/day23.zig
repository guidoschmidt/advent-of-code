...
const Route = struct {
    ...
    pub fn findNext_part1(self: *Route, gpa: Allocator, map: *[][]u8) !std.array_list.Managed(Route) {
        var split_routes = std.array_list.Managed(Route).init(gpa);
    ...
    pub fn findNext_part2(self: *Route, gpa: Allocator, map: *[][]u8, viz_map: *[][]u8) !std.array_list.Managed(Route) {
        var split_routes = std.array_list.Managed(Route).init(gpa);
...
fn part1(gpa: Allocator, input: []const u8) anyerror!void {
    ...
    var routes = std.array_list.Managed(Route).init(gpa);
    ...
    var finished_routes = std.array_list.Managed(Route).init(gpa);
